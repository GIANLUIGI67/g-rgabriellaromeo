...
struct L10n {
    ...
    enum Key: String {
        ...
        case bankTransfer, confirmBankTransfer, terms, orderConfirmed, bankTransferShippingNotice, orderEmailNotice, profileRequired
    ...
    private static let table: [Key: [AppLanguage: String]] = [
        ...
        .bankTransferShippingNotice: [.it: "Riceverai una conferma della spedizione dopo la verifica del bonifico. I prodotti saranno spediti esclusivamente dopo la ricezione del bonifico in entrata.", .en: "You will receive shipping confirmation after the bank transfer has been verified. Products will only be shipped after the incoming transfer is received.", .fr: "Vous recevrez une confirmation d'expédition après vérification du virement. Les produits seront expédiés uniquement après réception du virement.", .de: "Sie erhalten eine Versandbestätigung, nachdem die Überweisung geprüft wurde. Die Produkte werden erst nach Eingang der Überweisung versendet.", .es: "Recibirá la confirmación de envío después de verificar la transferencia. Los productos se enviarán solo tras recibir la transferencia.", .ar: "ستتلقى تأكيد الشحن بعد التحقق من التحويل البنكي. سيتم شحن المنتجات فقط بعد استلام التحويل.", .zh: "银行转账验证后，您将收到发货确认。商品仅在收到转账后发货。", .ja: "銀行振込の確認後、発送確認をお送りします。商品は入金確認後にのみ発送されます。"],
        .orderEmailNotice: [.it: "Ti invieremo una email con i dettagli dell'ordine.", .en: "We will send you an email with the order details.", .fr: "Nous vous enverrons un email avec les détails de la commande.", .de: "Wir senden Ihnen eine E-Mail mit den Bestelldetails.", .es: "Le enviaremos un email con los detalles del pedido.", .ar: "سنرسل لك بريدًا إلكترونيًا بتفاصيل الطلب.", .zh: "我们会向您发送包含订单详情的电子邮件。", .ja: "ご注文内容をメールでお送りします。"],
