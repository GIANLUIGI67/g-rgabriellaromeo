...
export default function UserMenu({ lang }) {
  ...
  const translations = {
    ...
    register: {
      it: 'Registrati', en: 'Register', fr: 'S’inscrire', es: 'Registrarse', de: 'Registrieren',
      zh: '注册', ja: '登録', ar: 'تسجيل'
    },
    googleLogin: {
        ...
        <div className="fixed top-0 right-0 w-96 h-full bg-white text-black z-50 p-6 shadow-xl overflow-y-auto">
          ...
          {!utente ? (
            <div className="space-y-3">
              ...
              <button onClick={registraUtente} className="w-full bg-black text-white py-2 rounded uppercase">
                {modalitaRegistrazione ? translations.register[lang] || 'REGISTRATI' : translations.login[lang]}
              </button>
