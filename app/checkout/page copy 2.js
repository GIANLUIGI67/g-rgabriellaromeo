...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    // Recupera lingua dal localStorage (salvata da FlagLanguageSwitcher)
  ...
  try {
    // 1) Verifica se esiste già un profilo cliente con questa email
    ...
    if (esistente) {
      // 2) Se ESISTE: aggiorna i dati anagrafici SENZA toccare primo_sconto/nuovo_sconto
      ...
      // 3) Se NON ESISTE: crea il profilo e registra il PRIMO SCONTO = '10'
      const { error: insError } = await supabase
        ...
        .insert([{
          ...
          paese,
          codice_postale: cap,
          primo_sconto: '10',     // <-- registrazione del primo sconto 10%
          nuovo_sconto: null,     // per referral in futuro
