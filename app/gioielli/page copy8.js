...
export default function GioielliPage() {
  ...
  const traduzioni = {
    ...
    en: {
      ...
      checkout: 'Checkout',
      indietro: 'Back',
      sold: 'SOLD – to order please review our production policy'
    },
    fr: {
      ...
      checkout: 'Paiement',
      indietro: 'Retour',
      sold: 'VENDU – veuillez consulter notre politique de production'
    },
    de: {
      ...
      checkout: 'Zur Kasse',
      indietro: 'Zurück',
      sold: 'AUSVERKAUFT – bitte beachten Sie unsere Produktionsrichtlinien'
    },
    es: {
      ...
      checkout: 'Pagar',
      indietro: 'Atrás',
      sold: 'VENDIDO – consulta nuestra política de producción'
    },
    ar: {
      ...
      checkout: 'الدفع',
      indietro: 'عودة',
      sold: 'تم البيع - الرجاء مراجعة سياسة الإنتاج لدينا'
    },
    zh: {
      titolo: '珠宝画廊',
      sottotutte: '所有子类别',
